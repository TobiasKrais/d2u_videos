...
if (filter_input(INPUT_POST, "btn_save") == 1 || filter_input(INPUT_POST, "btn_apply") == 1) {
	...
	if(filter_input(INPUT_POST, "btn_apply") == 1 && $playlist !== FALSE) {
		header("Location: ". rex_url::currentBackendPage(array("entry_id"=>$playlist->playlist_id, "func"=>'edit', "message"=>$message), FALSE));
	}
	else {
